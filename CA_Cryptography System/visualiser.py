...
class Visuals:
    ...
    def visualize_all(self, bin_string, initial_state, final_state, evol, encrypted_bin, decrypted_bin):
        data = [initial_state, final_state, 
            evol, bin_string, 
            encrypted_bin, decrypted_bin]
    
        titles = ['Initial State', 'Final State', 
              'Evolution', 'Binary Representation of Text', 
              'Encrypted Binary Text', 'Decrypted Binary Text']
